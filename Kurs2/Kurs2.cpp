...
// Kurs2.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKurs2App, CWinApp)
...
// Единственный объект CKurs2App

CKurs2App theApp;


// инициализация CKurs2App

BOOL CKurs2App::InitInstance()
{
